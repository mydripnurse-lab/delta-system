...
export function PartnerTestimonials() {
  ...
  useEffect(() => {
    ...
    let restoreFrameRequest: number | null = null;
    if (navigation?.type === "back_forward") {
      restoreFrameRequest = window.requestAnimationFrame(() => {
    ...
    return () => {
      ...
      if (restoreFrameRequest !== null) window.cancelAnimationFrame(restoreFrameRequest);
