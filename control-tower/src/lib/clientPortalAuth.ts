...
export { safeClientReturnUrl } from "@/lib/clientAuthDestination";
...
export function safeClientNext(value: unknown, fallback = "/") {
  ...
  const allowed = new Set(["/", "/book", "/services", "/appointments", "/products", "/profile", "/referrals", "/rewards", "/rewards/invitations", "/rewards/nad", "/rewards/visits", "/refund-request"]);
