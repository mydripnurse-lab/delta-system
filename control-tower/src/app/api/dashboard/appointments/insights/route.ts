  ...
  try {
      ...
      properties: {
        ...
        opportunities: {
          ...
          items: {
            ...
            required: ["title", "why_it_matters", "evidence", "expected_impact", "recommended_actions"],
          },
        },
    ...
    const resp = await client.responses.create({
      ...
      text: {
        format: {
          type: "json_schema",
          name: "appointments_dashboard_insights",
          schema,
        },
      },
    });
    ...
    return NextResponse.json(
      { ok: false, error: e?.message || "Failed to generate appointments insights" },
      { status: 500 },
    );
  }
}
