        ...
        <main className={styles.main}>
          ...
          <div className={styles.content}>
            ...
            {screen === "affiliates" ? <section className={`${styles.panel} ${styles.affiliateDashboard}`} id="affiliates">
              <div className={styles.panelHeading}><div><span>Affiliate center</span><h2>Your referral earnings</h2></div><span className={styles.affiliateRateBadge}>{affiliateDisplayDashboard?.commissionRate ?? 2}% commission</span></div>
