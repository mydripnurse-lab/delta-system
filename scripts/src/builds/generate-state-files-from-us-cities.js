...
const OUT_DIR_ENV = String(process.env.STATE_FILES_OUT_DIR || "").trim();
const OUT_DIR = OUT_DIR_ENV
    ? path.isAbsolute(OUT_DIR_ENV)
        ? OUT_DIR_ENV
        : path.join(REPO_ROOT, OUT_DIR_ENV)
    : path.join(REPO_ROOT, "resources", "statesFiles");
